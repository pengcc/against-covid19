...
const en_US: ILocalization = {
  ...
  NO_DELIVERY_INSTRUCTIONS: 'There’s no additional delivery instruction.',
  DELIVERY_RECOMMENDATION:'You’re recommended to verify with the hospital first before you donate.',
  CLINIC_PAGE_TITLE: 'Supply request details',
  ...
  VIEW_MAP: '查看地图',
  VIEW_MORE: '查看更多',
  VIEW_OFFICIAL_INFO: '查看详情',
  VIEW_OFFICIAL_DONATE_INFO: '查看官方捐款信息',
  VIEW_PREVENTION: '预防与隔离指南',
  VIEW_RENMIN_PAPER: '开启求助通道',
  VIEW_PRODUCTION: '查看生产厂家',
  VIEW_QINGHUA_SITE: '清华大学官方',
  VIEW_SOURCE: '查看来源',
  VOLUNTEER_INTRO1: '这个网站的全部工作都是由志愿者自发完成的。我们还需要你的帮助。',
  VOLUNTEER_INTRO2: '点击这里，如果你想加入我们，奉献为武汉疫情奉献一份力量',
